...
class GetUserFollowingsViewModel @Inject constructor(private val getUserFollowingsUseCase: GetUserFollowingsUseCase) : BaseViewModel<GetUserFollowingsViewModel.Input, GetUserFollowingsViewModel.Output>() {
    ...
    data class Output(
        val response: LiveData<UIGetFollowingsUsersResponse>,
