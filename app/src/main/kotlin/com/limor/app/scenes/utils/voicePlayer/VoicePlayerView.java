...
package com.limor.app.scenes.utils.voicePlayer;
    ...
    public VoicePlayerView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.item_input_with_audio
                , this);
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        try{
            ...
            playPaueseBackgroundColor = typedArray.getColor(R.styleable.VoicePlayerView_playPauseBackgroundColor, getResources().getColor(R.color.colorAccent));
            ...
            visualizationNotPlayedColor = typedArray.getColor(R.styleable.VoicePlayerView_visualizationNotPlayedColor, getResources().getColor(R.color.colorAccent));
        ...
        LayoutInflater.from(context).inflate(R.layout.item_input_with_audio, this);
        ...
        ((Activity)context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mediaPlayer.getDuration() - mediaPlayer.getCurrentPosition() > 100) {
                    long textTime = (mediaPlayer.getDuration() / 1000) - (mediaPlayer.getCurrentPosition() / 1000);
//                    time.setText(convertSecondsToHMmSs(mediaPlayer.getCurrentPosition() / 1000) + " / " + convertSecondsToHMmSs(mediaPlayer.getDuration() / 1000));
                    time.setText(convertSecondsToHMmSs(textTime));
                }
                else {
