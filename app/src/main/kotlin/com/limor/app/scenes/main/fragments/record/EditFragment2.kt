...
class EditFragment2 : WaveformFragment() {
    ...
    companion object {
        val TAG: String = EditFragment2::class.java.simpleName
        fun newInstance() = EditFragment2()
...
//        findNavController().popBackStack()
        ...
        if (markerSets != null && markerSets.size > 0) {
            ...
            uiDraft!!.filePath = editedWithMarkersFileName
            uiDraft!!.editedFilePath = editedWithMarkersFileName  //TODO JJ este formato de fichero es m4a y está en otro directory
        } else {
        ...
        if (uiDraft!!.filePath!!.endsWith("m4a")) {
            ...
            if (rc == RETURN_CODE_SUCCESS) {
                ...
                uiDraft!!.filePath = wavFileInCustomFolder.absolutePath
                uiDraft!!.timeStamps = timeStamps
                uiDraft!!.length = player.duration.toLong() //si modifico el audio y le doy atrás, el record sigue mostrando la duración del audio original, no el editado
