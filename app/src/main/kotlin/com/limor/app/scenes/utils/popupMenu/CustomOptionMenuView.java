 ...
 */
public class CustomOptionMenuView extends LinearLayout implements PopLayout.OnBulgeChangeCallback, View.OnClickListener {
    ...
    private int mItemRes = R.layout.layout_menu_popup_item;

    private OnOptionMenuClickListener mMenuClickListener;

    private int mLeftPadding, mTopPadding, mRightPadding, mBottomPadding;

    public CustomOptionMenuView(Context context) {
        this(context, null, 0);
    }

    public CustomOptionMenuView(Context context, int itemRes) {
        this(context);
        if (itemRes != 0) mItemRes = itemRes;
    }

    public CustomOptionMenuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomOptionMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomOptionMenuView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private CustomOptionItemView newMenuItemView() {
        CustomOptionItemView itemView = (CustomOptionItemView) inflate(getContext(), mItemRes, null);
