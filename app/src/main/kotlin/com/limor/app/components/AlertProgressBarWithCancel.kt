...
class AlertProgressBarWithCancel(val context: Context, cancelCallback: () -> Unit) {
    ...
    init {
        ...
        val dialogLayout = inflater.inflate(R.layout.component_progress_bar_with_cancel, null)
